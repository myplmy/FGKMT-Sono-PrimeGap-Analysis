...
NOTES_BY_ID = {
    ...
    "79.1": "FMT first-stage A와 conditional second-stage N-prime의 joint-law factorization 정의",
    "79.2": "Theory 55 uniform conditional failure에서 얻는 project sieve-good mass; full probability proof는 Lean 미형식화",
    "79.3": "최종 residue가 outer A와 inner N-prime 양쪽에 의존한다는 source 구조 정의",
    "79.4": "Theory 55 식 (55.17)의 outer failure bound 재사용",
    "79.5": "Theory 55 식 (55.20)--(55.21)의 uniform conditional inner failure 재사용",
    "79.6": "조건부 law를 합한 project finite-mass proof; exact Python 검산, Lean probability 미형식화",
    "79.7": "failure upper의 analytic premise는 입력; 마지막 exact 실수대수 identity를 커널 검증",
    "79.8": "joint construction outcome에 의존하는 weighted character coefficient 정의",
    "79.9": "같은 joint law의 union lower bound; analytic correlation input은 OPEN",
    "79.10": "same-law correlation failure가 sieve mass보다 작을 때 positive slack인 scalar terminal",
    "79.11": "비음수 failure에서 crude union gate가 product gate를 함의하는 조건부 실수대수",
    "79.12": "fiberwise probability 식은 미형식화; 대응 finite outer/fiber selection은 커널 검증",
    "79.13": "Markov probability 식은 exact Fraction 검산; actual badness expectation은 OPEN",
    "80.1": "actual final FMT joint outcome 정의",
    "80.2": "Sono primorial modulus와 fixed offset interval 정의",
    "80.3": "joint outcome별 survivor set과 count 정의",
    "80.4": "nonunit-zero character convention의 shifted full-interval identity; Lean 미형식화",
    "80.5": "nonprincipal weighted prime-error observable 정의",
    "80.6": "남은 positive relative-error budget 정의",
    "80.7": "direct weighted-correlation target 정의",
    "80.8": "outer-good domain의 divide-by-zero-safe normalized squared badness 정의",
    "80.9": "normalized target equivalence는 Python 경계검사; character absolute-value Lean proof 대기",
    "80.10": "finite tower와 flat joint-atom 합의 대수 identity를 커널 검증",
    "80.11": "Theory 79의 parameterized sieve-good mass 재사용",
    "80.12": "Markov probability input은 analytic premise; exact finite fixture 검산",
    "80.13": "global joint-success probability lower는 미형식화; positive terminal만 조건부 커널 검증",
    "80.14": "global moment strict gate에서 positive terminal mass로 가는 조건부 커널 검증",
    "80.15": "outer-good conditional moment 정의",
    "80.16": "conditional probability lower는 미형식화; product positivity terminal만 커널 검증",
    "80.17": "conditional moment strict gate의 scalar terminal을 커널 검증",
    "80.18": "uniform outer-good-fiber analytic moment target; source theorem 미발견",
    "80.19": "uniform-fiber strict gate의 같은 scalar terminal을 조건부 커널 검증",
    "80.20": "raw same-law second-moment analytic input; source theorem 미형식화",
    "80.21": "positive pointwise denominator의 정규화 identity·단조성을 조건부 커널 검증",
