...
NOTES_BY_ID = {
    ...
    "55.26": "h(t) scalar 정의만 전사; prime sum·적분 항등식은 미형식화",
    "55.27": "theta bound와 Stieltjes 부분적분 source theorem 미형식화",
    "T55-U002": "Ein interval-integral 정의 전사; delta L=w는 downstream premise",
    "55.28": "half-tail·improper integral·51/50 factor 검증; finite-interval 비교는 후속",
    "T55-U003": "두 적분 piece 상계 premise 이후 103/100 합성",
    "55.29": "Stieltjes·Ein premise 이후 actual parameter와 189/160 합성",
