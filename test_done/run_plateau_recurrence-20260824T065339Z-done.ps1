...
Invoke-LoggedNativeStage -Name 'preflight' -FilePath $Python -Arguments @(
    '-B', '-m', 'source.plateau_recurrence_cli', 'preflight',
...
Invoke-LoggedNativeStage -Name 'approved-analysis' -FilePath $Python -Arguments @(
    '-B', '-m', 'source.plateau_recurrence_cli', 'analyze',
    '--records-path', $RecordsPath,
...
Invoke-LoggedNativeStage -Name 'saved-artifact-verification' -FilePath $Python -Arguments @(
    '-B', '-m', 'source.plateau_recurrence_cli', 'verify',
