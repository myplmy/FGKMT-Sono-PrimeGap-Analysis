...
\(k\ge10^{200}\)에서 relative/additive multiplier 1/1로 닫았다. 아직 unweighted P91,
growing-k P94 호환성 및 공통 정규화가 남으므로 broad SIV-07/08/09는 HARD_BLOCKER,
...
다음 권장 행동은 P018-B가 아니라 H1b-P91a다. H1b-P92a는 actual identity weighted
...
새 \(I(F_1)\le2I(F),J(F_1)\le2J(F)\)를 P91 및 P94의 growing-k gate에 적용한 뒤
