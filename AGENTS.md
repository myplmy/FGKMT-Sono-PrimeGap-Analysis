...
다음 권장 행동은 P018-B가 아니라 H1b-COR2 / DEP-R05 off-tuple 예산 감사다. H1b-DEP는 완료했고
P95가 actual 경로의 직접·간접 필수 입력이 아님을 확인했다. general P95는 별도 OPEN으로 보존한다.
actual 의존지도 theory 48은 당시 이력을 보존한다. 최신 정본은
docs/method/theory/49_Sono_FMT_H1bCOR1_finite_correlation_conditioning.md와
docs/review/55_20260909_H1bCOR1_finite_correlation_타당성검토.md다.
R01 correlation, R02 conditioning/희소성, R04 good-P failure와 actual small-codegree가 닫혀
현재 9작업/6묶음이 남는다. 이 개수는 완료율이 아니며 full hypergraph·X_cert는 OPEN이다. H1b-NORM은
