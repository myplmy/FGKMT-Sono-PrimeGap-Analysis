...
다음 권장 행동은 P018-B가 아니라 DEP-R09 `JL7-LEMMA3` absolute-sum multiplier의
source-first 복원이다. Theory 66에서 식 (3.6)의 올바른 \(\theta\)-의존 weighted call,
finite logarithmic correction, weight quotient·area·off-diagonal margin을 닫았고,
Theory 67에서 shifted-contour multiplier까지 닫았다. 그 다음은 `JL7-RES`,
