"""CLI for the approval-gated P017 16-hour calibration queue."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--max-wall-seconds", type=int, default=MAX_WALL_SECONDS)
    run.add_argument("--max-disk-gb", type=int, default=5)
